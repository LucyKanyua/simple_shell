...
void _interactive(Node **head, char **buffer, char **token,
		size_t *no_read, size_t *chars, char **program_name, char **path);
...
void _file(Node **head, char *filename, char **program_name, char **path);
void execute_file(Node **head, int fd, char **program_name, char **path);
...
void _execute_file(Node **head, ssize_t *num_read,
		char **buff, char **line, char **tokens, char **temp, int *fd,
			int *status, int *count, char **token, char **program_name, char **path);
